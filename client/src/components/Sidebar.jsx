    ...
    text-white ${selectedUser ? "max-md:hidden" : ''}`}>
        <div className='pb-5'>
            <div className='flex justify-between items-center'>
                ...
                <img src={assets} alt="ChatIcon" className='max-w-40' />

                <div className='relative py-2 group'>
                <img src={assets1} alt="Menu" className='max-w-5 cursor-pointer' />
            ...
            <div className='bg-[#282142] rounded-full flex iems-center gap-2
            py-3 px-4 mt-5'>

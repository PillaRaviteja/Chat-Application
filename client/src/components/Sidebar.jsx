...
import { userDummyData,asset} from '../assets/assets'
    ...
    text-white ${selectedUser ? "max-md:hidden" : ''}`}>
        <div className='pb-5'>
            <div className='flex justify-between items-center'>
                ...
                <img src={assets} alt="ChatIcon" className='max-w-14' />

                <div className='relative py-2 group'>
                <img src={assets1} alt="Menu" className='max-h-5 
                cursor-pointer' />
     ...
     <div  className='flex flex-col'>
            {userDummyData.map((user, index)=>(
                    ...
                    cursor-pointer max-sm:text-sm ${selectedUser?.id === user._id && 'bg-[#282142]/5'}` }>

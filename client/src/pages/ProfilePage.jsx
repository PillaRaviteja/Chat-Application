...
import logo_icon from '../assets/app_messages.png'
// import {avatar_icon , logo_icon } from '../assets/assets'

const ProfilePage = () => {
  
  const [selectedImg, setSelectedImg] = useState(null)
  const navigate = useNavigate();
  const [name,setName] = useState("Raviteja Pilla");
  ...
  return (
    <div className='main h-screen bg-cover bg-no-repeat flex items-center 
    justify-center'>
      ...
      rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          cursor-pointer'>
            ...
            <img src={selectedImg ? URL.createObjectURL(selectedImg) : avatar_icon} alt='' className={`w-12 h-12 ${selectedImg && 
              'rounded-full' } `} />
